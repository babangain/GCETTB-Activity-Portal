...
<?php
	...
	?>
 <?php
		$sql="INSERT INTO otherfeedback (name,mob,email,org,desig,address,comment,browser,version,os,date,ip) VALUES ('$name','$mob','$email','$org','$desig','$address','$comment','$browser','$version','$os','$date','$ip')";
